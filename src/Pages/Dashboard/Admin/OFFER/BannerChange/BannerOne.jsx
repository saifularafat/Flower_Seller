    ...
    const onSubmit = (data) => {
        ...
        fetch(hosting_image_url, {
            ...
            .then(imageData => {
                ...
                const { bannerSerialOne, bannerOneLink, category } = data;
                const bannerOneInfo = {
                    bannerOne: imageURL,
                    bannerOneLink,
                    bannerSerialOne,
        ...
        <div>
            <div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input
                        {...register("bannerOne", { required: true })}
                        type="file"
