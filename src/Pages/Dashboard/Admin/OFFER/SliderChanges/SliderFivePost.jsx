...
const SliderFivePost = () => {
    ...
    const onSubmit = (data) => {
        const imgUrl = data.sliderFive[0];
        ...
        fetch(hosting_image_url, {
            ...
            .then(imageData => {
                ...
                const { sliderSerialFive, category } = data;
                const sliderFiveInfo = {
                    sliderFive: imageURL,
                    sliderSerialFive,
                    category
                }
                axios.post(`${import.meta.env.VITE_API_URL}/sliderImage`, sliderFiveInfo)
                    .then(data => {
        ...
        <div>
           <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <input
                    ...
                    placeholder=""
                    defaultValue=""
                    {...register("sliderFive", { required: true })}
