    ...
    const onSubmit = (data) => {
        ...
        fetch(hosting_image_url, {
            ...
            .then(imageData => {
                ...
                const { sliderSerialTwo, category } = data;
                const sliderTwoInfo = {
                    sliderTwo: imageURL,
                    sliderSerialTwo,
                    category
                }
                axios.post(`${import.meta.env.VITE_API_URL}/sliderImage`, sliderTwoInfo)
                    .then(data => {
        ...
        <div>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <input
                    ...
                    placeholder=""
                    defaultValue=""
                    {...register("sliderTwo", { required: true })}
...
export default SliderSecondPost;