    ...
    const onSubmit = (data) => {
        ...
        fetch(hosting_image_url, {
            ...
            .then(imageData => {
                ...
                const { sliderSerialSix, category } = data;
                const sliderSixInfo = {
                    sliderSix: imageURL,
                    sliderSerialSix,
                    category
                }
                axios.post(`${import.meta.env.VITE_API_URL}/sliderImage`, sliderSixInfo)
                    .then(data => {
        ...
        <div>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <input
                    ...
                    placeholder=""
                    defaultValue=""
                    {...register("sliderSix", { required: true })}
