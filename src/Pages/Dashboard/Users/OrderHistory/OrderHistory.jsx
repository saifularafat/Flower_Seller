        ...
        <div>
            ...
            <div className="grid md:grid-cols-3 gap-5">
                <div className="px-2 py-4 shadow-lg font-sans rounded-xl space-y-2 h-auto bg-white">
                    ...
                    <div className="flex items-center flex-wrap gap-6 text-sm md:text-base">
                ...
                <div className="px-2 py-4 shadow-lg font-sans rounded-xl space-y-6 bg-white">
                    <div className="flex w-full h-44 lg:h-[260px] relative">
                        <img className="rounded-lg bg-black/40 w-full h-full" src="https://source.unsplash.com/300x300/?macbook" alt="order flower" />
                    </div>
                    <div className=" font-semibold space-y-1 ">
                        <h6 className="text-sm md:text-base lg:text-lg">Waterproof Sport HD Monitor for MacBook</h6>
            ...
            {/* <div className="overflow-x-auto">
                <table className="min-w-full border border-gray-200 bg-white shadow-lg">
                    ...
                    <tbody>
                        ...
                        <tr className="h-[70px] border-b bg-[#667caa] text-[#FFFFFF]">

                            <th className="px-6 py-4 text-start">
                                <img className="h-14 w-14  bg-slate-500 object-cover" src="https://source.unsplash.com/300x300/?profile" />
                            </th>
