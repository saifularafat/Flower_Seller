...
const TrendingGift = () => {
    return (
        <div className="md:my-14 mt-10 md:overflow-x-hidden overflow-x-scroll mx-2 md:mx-0">
            <div className="grid grid-cols-8 gap-3 w-[1320px] mx-auto md:overflow-x-hidden overflow-x-scroll">
                <Link to="" className=" border border-white rounded-md shadow-md p-0">
                    <img src={trending1} loading='lazy' alt="flowerTrending" className="hover:scale-105 transition-all duration-200" />
                    <h4 className="text-lg font-medium tracking-wide">Festive Frosty</h4>
                    <span className="text-xl font-bold">$56.10</span>
                </Link>
                <Link to="" className=" border border-white rounded-md shadow-md p-0">
                    <img src={trending2} loading='lazy' alt="flowerTrending" className="hover:scale-105 transition-all duration-200" />
                    <h4 className="text-lg font-medium tracking-wide">Dashing Through</h4>
                    <span className="text-xl font-bold">$49.35</span>
                </Link>
                <Link to="" className=" border border-white rounded-md shadow-md p-0">
                    <img src={trending3} loading='lazy' alt="flowerTrending" className="hover:scale-105 transition-all duration-200" />
                    <h4 className="text-lg font-medium tracking-wide"> Sparkling Holiday</h4>
                    <span className="text-xl font-bold">$51.40</span>
                </Link>
                <Link to="" className=" border border-white rounded-md shadow-md p-0">
                    <div className="relative">
                        <img src={trending4} loading='lazy' alt="flowerTrending" className="hover:scale-105 transition-all duration-200" />
                ...
                <Link to="" className=" border border-white rounded-md shadow-md p-0">
                    <img src={trending5} loading='lazy' alt="flowerTrending" className="hover:scale-105 transition-all duration-200" />
                    <h4 className="text-lg font-medium tracking-wide">Field Europe</h4>
                    <span className="text-xl font-bold">$46.87</span>
                </Link>
                <Link to="" className=" border border-white rounded-md shadow-md p-0">
                    <div className="relative">
                        <img src={trending6} loading='lazy' alt="flowerTrending" className="hover:scale-105 transition-all duration-200" />
                        <div className="absolute bottom-2 left-2 w-2/3 bg-slate-100 rounded-md">
                ...
                <Link to="" className=" border border-white rounded-md shadow-md p-0">
                    <img src={trending8} loading='lazy' alt="flowerTrending" className="hover:scale-105 transition-all duration-200" />
                    <h4 className="text-lg font-medium tracking-wide"> Pegantasion Gift</h4>
                    <span className="text-xl font-bold">$44.90</span>
                </Link>
                <Link to="" className=" border border-white rounded-md shadow-md p-0">
                    <div className="relative">
                        <img src={trending7} loading='lazy' alt="flowerTrending" className="hover:scale-105 transition-all duration-200" />
                        <div className="absolute bottom-2 left-2 w-2/3 bg-slate-100 rounded-md">
