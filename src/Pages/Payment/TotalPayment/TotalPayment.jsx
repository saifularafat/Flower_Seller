                ...
                </thead>
                {
                    totalPayment.map((pay, index) =>
                        <tbody key={pay?._id}>
                            <tr>
                                <th>{index + 1}</th>
                                <td>{pay?.name ? pay?.name : pay?.orderInfo?.name}</td>
                                <td>{pay?.transition_id ? pay?.transition_id : pay?.paymentType}</td>
                                <td>{pay?.totalPrice ? pay?.totalPrice : pay?.orderInfo?.totalPrice}</td>
                                <td
