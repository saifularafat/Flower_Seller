                        ...
                        <div className="grid md:grid-cols-4 grid-cols-2 md:gap-5 gap-3">
                            {
                                plantsTotal.map(plant =>
                                    <div key={plant?._id} className="w-full md:h-[480px] h-[300px] hover:shadow-xl transition-all duration-200 rounded overflow-hidden">
                                        <Link to={`/flowerDetails/${plant?._id}`} className="">
                                            ...
                                            <div className="px-2 pt-2">
                                                <h4 className="text-lg md:font-semibold font-medium leading-tight">{plant?.flowerName}</h4>
                                            </div>
                                        </Link>
