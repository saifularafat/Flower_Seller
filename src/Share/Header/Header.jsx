    ...
    return (
        <div className="">
            <Marquee className="" speed={30}>
                <div className="grid grid-cols-9 md:gap-7 gap-1">
                    <Link to="" className="py-3 px-3 border-t-0  border-b-[2px] border-l-[0.5px] border-r-[0.5px] border-solid border-slate-100 hover:border-b-[2px] hover:border-t-0 hover:border-b-slate-800 transition-all duration-300 opacity-60 hover:opacity-100">
                        <img src={img1} alt="" className="object-cover w-full lg:h-10 md:h-9   h-6 mx-auto " />
                    </Link>
                    <Link to="" className="top_header_one">
                        <img src={img2} alt="" className="object-cover w-full lg:h-10 md:h-9   h-6 mx-auto " />
                    </Link>
                    <Link to="" className="top_header_two">
                        <img src={img3} alt="" className="object-cover w-full lg:h-10 md:h-9   h-6 mx-auto " />
                    </Link>
                    <Link to="" className="top_header_one">
                        <img src={img4} alt="" className="object-cover w-full lg:h-10 md:h-9   h-6 mx-auto " />
                    </Link>
                    <Link to="" className="top_header_two">
                        <img src={img5} alt="" className="object-cover w-full lg:h-10 md:h-9   h-6 mx-auto " />
                    </Link>
