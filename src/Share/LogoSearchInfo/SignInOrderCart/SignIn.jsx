        ...
        <div className="relative cursor-pointer group">
            <div className="w-full mx-auto group-hover:block">
                <div className="relative group">
                    ...
                    {
                        user && <>
                            <span className="md:h-3 h-2 md:w-3 w-2 bg-green-500 absolute rounded-full bottom-[2px] md:right-1 right-0 md:border-[2px] border border-white"></span>
                            <span className="md:h-3 h-2 md:w-3 w-2 bg-green-500 absolute rounded-full bottom-[2px] md:right-1 right-0 animate-ping transition-all duration-300"></span></>
                    }
                </div>
            </div>
            {
