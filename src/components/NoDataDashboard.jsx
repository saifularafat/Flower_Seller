                ...
                <div className="md:pt-5 pt-3 flex items-center justify-center">
                    <Link to={link} className="">
                        <button className="bg-sky-600 flex items-center justify-center text-white font-semibold text-base overflow-hidden group">
                            <span className="inline-block bg-sky-900 px-[10px] py-2 after:content-['H'] after:absolute after:inset-0 relative after:flex after:justify-center after:items-center after:-translate-y-full group-hover:translate-y-full duration-500">H</span>
                            <span className="inline-block bg-sky-900 px-[10px] py-2 after:content-['O'] after:bg-sky-400 after:absolute after:inset-0 relative after:flex after:justify-center after:items-center after:translate-y-full group-hover:-translate-y-full duration-500">O</span>
                            <span className="inline-block bg-sky-900 px-[10px] py-2 after:content-['M'] after:absolute after:inset-0 relative after:flex after:justify-center after:items-center after:-translate-y-full group-hover:translate-y-full duration-500">M</span>
                            ...
                            {/* <span className="inline-block bg-sky-900 px-[10px] py-2 after:content-['I'] after:absolute after:inset-0 relative after:flex after:justify-center after:items-center after:-translate-y-full group-hover:translate-y-full duration-500"></span>
